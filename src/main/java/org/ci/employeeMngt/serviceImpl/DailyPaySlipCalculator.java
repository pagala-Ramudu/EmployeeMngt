...
@Component
public class DailyPaySlipCalculator implements PaySlipCalculator {
    private static final double EMPLOYEE_DAILY_SALARY = 1000;
    ...
    public String calculatePaySlip(Long empId) {
        try {
            ...
            int totalPresentDays = (int) attendanceList.stream()
            ...
            return "Daily Pay slip generated successfully for empId: " + empId;
        } catch (Exception e) {
